...
@staticmethod
def compute_transf_mat(pts1, pts2, K):
    """
    ...
    T = construct_transf_mat(R, np.squeeze(t))
    return T

@staticmethod
def optimize_pose(E, pts1, pts2):
    """
    ...
    for R, t in solutions:
        ...
        solutions_relative_scales.append(relative_scale)
    ...
    self.camera.world_points.append(Q1)
